fertilizer_dic= {
    "NHigh": 
    { "cause" : "The N value of soil is high and might give rise to weeds.",
      "Suggestions" : ["1.  Manure – adding manure is one of the simplest ways to amend your soil with nitrogen. Be careful as there are various types of manures with varying degrees of nitrogen ",
    ...
    "Nlow":
     { "cause" : "The N value of your soil is low",
      "Suggestions" : ["1. Add sawdust or fine woodchips to your soil – the carbon in the sawdust/woodchips love nitrogen and will help absorb and soak up and excess nitrogen.",
                       ...
                       "7. Use NPK fertilizers with high N value.8. Do nothing– It may seem counter-intuitive, but if you already have plants that are producing lots of foliage, it may be best to let them continue to absorb all the nitrogen to amend the soil for your next crops."]
     }, 
    "PHigh": 
    { "cause" : "The P value of your soil is high",
       "Suggestions" : ["1. Avoid adding manure – manure contains many key nutrients for your soil but typically including high levels of phosphorous. Limiting the addition of manure will help reduce phosphorus being added.",
     ...
     "Plow": 
     { "cause" :"The P value of your soil is low",
        "Suggestions" : ["1. Bone meal– a fast acting source that is made from ground animal bones which is rich in phosphorous.",
    ...
    "KHigh":
     {  "cause" :"The K value of your soil is high",
        "Suggestions" : ["1. Loosen the soil deeply with a shovel, and water thoroughly to dissolve water-soluble potassium. Allow the soil to fully dry, and repeat digging and watering the soil two or three more times.",
    ...
    "Klow":
     { 
        "cause" :  "The K value of your soil is low",
        "Suggestions" : ["1. Mix in muricate of potash or sulphate of potash",
