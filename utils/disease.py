disease_dic = {
    'Apple___Apple_scab': """#Crop:Apple#Disease:Apple Scab<br/>
        #Cause of Disease:
        ...
        <br/>#How to prevent/cure the disease:
    ...
    'Apple___Black_rot': """#Crop:Apple#Disease:Black Rot<br/>
        #Cause of Disease:
    ...
    'Apple___Cedar_apple_rust': """#Crop:Apple#Disease:Cedar Apple Rust<br/>
        #Cause of Disease:
    ...
    'Apple___healthy': """#Crop:Apple#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Blueberry___healthy': """#Crop:Blueberry#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Cherry_(including_sour)___Powdery_mildew': """#Crop:Cherry#Disease:Powdery Mildew<br/>
        #Cause of Disease:
    ...
    'Cherry_(including_sour)___healthy': """#Crop:Cherry#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """#Crop:Corn#Disease:Grey Leaf Spot<br/>
        #Cause of Disease:
    ...
    'Corn_(maize)___Common_rust_': """#Crop:Corn(maize)#Disease:Common Rust<br/>
        #Cause of Disease:
    ...
    'Grape___Black_rot': """#Crop:Grape#Disease:Black Rot<br/>
        #Cause of Disease:
    ...
    'Corn_(maize)___healthy': """#Crop:Corn(maize)#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Grape___Esca_(Black_Measles)': """#Crop:Grape#Disease:Black Measles<br/>
        #Cause of Disease:
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """#Crop:Grape#Disease:Leaf Blight<br/>
        #Cause of Disease:
    ...
    'Grape___healthy': """#Crop:Grape#Disease:No disease<br/>
    ...
    'Orange___Haunglongbing_(Citrus_greening)': """#Crop:Orange#Disease:Citrus Greening<br/>
        #Cause of Disease:
    ...
    'Peach___Bacterial_spot': """#Crop:Peach#Disease:Bacterial Spot<br/>
        #Cause of Disease:
    ...
    'Pepper,_bell___Bacterial_spot': """#Crop:Pepper#Disease:Bacterial Spot<br/>
        #Cause of Disease:
    ...
    'Peach___healthy': """#Crop:Peach#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Pepper,_bell___healthy': """#Crop:Pepper#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Potato___healthy': """#Crop:Potato#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Raspberry___healthy': """#Crop:Raspberry#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Soybean___healthy': """#Crop:Soyabean#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Strawberry___healthy': """#Crop:Strawberry#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Tomato___healthy': """#Crop:Tomato#Disease:No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Potato___Early_blight': """#Crop:Potato#Disease:Early Blight<br/>
        #Cause of Disease:
    ...
    'Potato___Late_blight': """#Crop:Potato#Disease:Late Blight<br/>
    ...
    'Squash___Powdery_mildew': """#Crop:Squash#Disease:Powdery mildew<br/>
        #Cause of Disease:
    ...
    'Strawberry___Leaf_scorch': """#Crop:Strawberry#Disease:Leaf Scorch<br/>
        #Cause of Disease:
    ...
    'Tomato___Bacterial_spot': """#Crop:Tomato#Disease:Bacterial Spot<br/>
        #Cause of Disease:
    ...
    'Tomato___Early_blight': """#Crop:Tomato#Disease:Early Blight<br/>
        #Cause of Disease:
    ...
    'Tomato___Late_blight': """#Crop:Tomato#Disease:Late Blight<br/>
    ...
    'Tomato___Leaf_Mold': """#Crop:Tomato#Disease:Leaf Mold<br/>
        #Cause of Disease:
    ...
    'Tomato___Septoria_leaf_spot': """#Crop:Tomato#Disease:Leaf Spot<br/>
        #Cause of Disease:
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': """#Crop:Tomato#Disease:Two-spotted spider mite<br/>
        #Cause of Disease:
    ...
    'Tomato___Target_Spo': """#Crop:Tomato#Disease:Target Spot<br/>
        #Cause of Disease:
    ...
    'Tomato___Tomato_Yellow_Leaf_Curl_Virus': """#Crop:Tomato#Disease:Yellow Leaf Curl Virus<br/>
        #Cause of Disease:
    ...
    'Tomato___Tomato_mosaic_virus': """#Crop:Tomato#Disease:Mosaic Virus<br/>
        #Cause of Disease:
